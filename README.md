# Layout for 34-key keyboard

## Design Philosophy
![corekeys](https://github.com/user-attachments/assets/68689c66-5bea-4325-a950-d2c7bb584cbd)

The layout primarily utilizes the Colemak DH layout for English input and QWERTY for Korean input. 

The keyboard layout prioritizes the home row for primary typing and relies heavily on thumb keys for essential modifiers. 
Secondary keys and layers are activated via specific combinations or by holding designated keys.

- Primary Keys: Home row keys and thumb keys.
- Layer Activation: Keys below the home row act as layer toggles when held.
...
![colmack dh](https://github.com/user-attachments/assets/a0111d50-e415-4b4a-9268-a3f0723e2e0b)
